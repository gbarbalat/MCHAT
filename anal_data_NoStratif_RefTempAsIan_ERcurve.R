...
plot_ER=function(which_cp,cp,name) {
  
  result_process_name <- process_name(name)
  
  main <- paste0(result_process_name$E1, result_process_name$E2)
    
  xlab=ifelse(grepl("Tm",name,fixed = TRUE),"Temperature (°C)","Concentration (µg/m^3)")
  xlab=ifelse(grepl("Tm",name,fixed = TRUE),"Temperature (°C)",
...
#plot ER curves
as.ggplot(function() {lapply(1,plot_ER,pred.PM2.5_preN,"pred.PM2.5_preN")})
as.ggplot(function() {lapply(1,plot_ER,pred.PM2.5_postN,"pred.PM2.5_postN")})

as.ggplot(function() {lapply(1,plot_ER,pred.PM10_preN,"pred.PM10_preN")})
as.ggplot(function() {lapply(1,plot_ER,pred.PM10_postN,"pred.PM10_postN")})

as.ggplot(function() {lapply(1,plot_ER,pred.NO2_preN,"pred.NO2_preN")})
as.ggplot(function() {lapply(1,plot_ER,pred.NO2_postN,"pred.NO2_postN")})


#Temperature
as.ggplot(function() { lapply(1,plot_ER,pred.Tmin_preN,"pred.Tmin_preN")})
as.ggplot(function() { lapply(1,plot_ER,pred.Tmin_postN,"pred.Tmin_postN")})
 
as.ggplot(function() { lapply(1,plot_ER,pred.Tmax_preN,"pred.Tmax_preN")})
as.ggplot(function() {lapply(1,plot_ER,pred.Tmax_postN,"pred.Tmax_postN")})

as.ggplot(function() { lapply(1,plot_ER,pred.Tmean_preN,"pred.Tmean_preN")})
as.ggplot(function() {lapply(1,plot_ER,pred.Tmean_postN,"pred.Tmean_postN")})
